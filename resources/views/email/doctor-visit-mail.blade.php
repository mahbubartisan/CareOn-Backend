...
<html lang="en">
    ...
    <head>
        ...
        <title>Doctor Visit Booking Confirmation</title>
    ...
    <body>
        ...
        <div class="container">
            ...
            <div class="header">
                ...
                <h1 class="title">Doctor Visit Booking Details</h1>
            </div>

            <p class="subtitle">
                @if ($recipientType === "admin")
                    A new doctor visit at home has been booked.
                ...
                @else
                    ...
                    Your doctor visit at home has been successfully booked.
