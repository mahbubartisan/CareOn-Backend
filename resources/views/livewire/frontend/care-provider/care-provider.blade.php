<div>
    ...
    <section class="bg-gradient-to-r from-[#1D927D] to-[#1D5A91] px-4 pb-12 pt-28 text-center text-white">
        <div>
            <div class="mx-auto max-w-4xl">
                <button class="mb-4 rounded-full bg-amber-500 px-3 py-1 text-xs font-semibold text-gray-900">
                    সেবা প্রদানকারী হুন | Join as Provider
                </button>
                <h1 class="mb-3 text-4xl font-bold sm:text-5xl">
                    CareOn-এ যোগ দিন এবং আয় করুন
                </h1>
            </div>
            <p class="mx-auto max-w-2xl text-lg text-white/90">
                Join Bangladesh's leading home healthcare platform and connect with
                families who need your professional care.
            </p>
        </div>
    </section>
    ...
    <section class="mx-auto max-w-5xl px-4 py-12">
        <h2 class="mb-10 text-center text-xl font-bold md:text-2xl">
            কেন CareOn বেছে নেবেন? |
            <span class="text-gray-800">Why Choose CareOn?</span>
        </h2>
        ...
        <div class="grid grid-cols-1 gap-6 sm:grid-cols-2 lg:grid-cols-4">
            ...
            <div class="rounded-xl border bg-white p-6 text-center">
                <div
                    class="mx-auto mb-4 flex h-12 w-12 items-center justify-center rounded-full bg-[#00B686]/10 text-[#00B686]">
                    <!-- Trend Up Icon -->
                ...
                <h3 class="mb-2 font-semibold">Flexible Income</h3>
                <p class="text-sm text-gray-500">
                    Earn based on your availability and skills
                </p>
            </div>
            ...
            <div class="rounded-xl border bg-white p-6 text-center">
                ...
                <h3 class="mb-2 font-semibold">Safety & Support</h3>
                <p class="text-sm text-gray-500">
            ...
            <div class="rounded-xl border bg-white p-6 text-center">
                ...
                <h3 class="mb-2 font-semibold">Professional Growth</h3>
                <p class="text-sm text-gray-500">
            ...
            <div class="rounded-xl border bg-white p-6 text-center">
                ...
                <h3 class="mb-2 font-semibold">Work-Life Balance</h3>
                <p class="text-sm text-gray-500">
                ...
                <div class="grid grid-cols-1 gap-4 lg:grid-cols-2">
                    <div class="md:col-span-2">
                        ...
                        <select wire:model="form.service_category"
                            ...
                            <option value="">-- Select one --</option>
                            <option value="Nursing Care">Nursing Care | নার্সিং কেয়ার</option>
                            <option value="Doctor">Doctor | ডাক্তার</option>
                            <option value="Physiotherapy">Physiotherapy | ফিজিওথেরাপি</option>
                            <option value="Nanny and Baby Care">
                                Nanny &amp; Baby Care | ন্যানি ও শিশু যত্ন
                            </option>
                            <option value="Elderly Care">Elderly Care | বয়স্ক যত্ন</option>
                            <option value="Patient Attendant">Patient Attendant | রোগী সেবক</option>
                ...
                <div class="mt-4" x-data="{ qualification: '', type: '' }">
                    ...
                    <div class="grid grid-cols-1 gap-x-6 gap-y-3 lg:grid-cols-2">
                        ...
                        <div>
                            ...
                            <input type="text" wire:model="form.qualification" placeholder="e.g., B.Sc in Nursing"
            ...
            <div class="mt-8 border-t pt-6">
                ...
                <div class="mt-6 border-t border-gray-200 pt-4">
                    <label class="flex items-start space-x-2">
                        <input type="checkbox" name="agree" wire:model='form.agree'
    ...
    <!-- Success Modal -->
    @if ($showModal)
        @include("livewire.frontend.care-provider.fragments.success-modal")
    @endif

    @push("title")
        CareOn - Provider Signup
    @endpush
</div>
