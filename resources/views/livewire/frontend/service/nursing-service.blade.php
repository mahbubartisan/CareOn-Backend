<div>
    <div x-data="{
        ...
        nursingServices: @js($nursingServices),
        service: @js($service),
        ...
        // -------------------------
        // SELECTED NURSING SERVICES
        // -------------------------
        get selectedServices() {
            return this.nursingServices.filter(s =>
                this.formData.nursingCare.includes(s.id)
            );
        },
        ...
        // -------------------------
        get totalPrice() {
            return this.nursingTotal + this.locationPrice;
        }
    }">
                ...
                <div class="mx-auto max-w-4xl">
                    ...
                    {{-- <div class="space-y-5">
                        ...
                        <div class="flex items-start gap-4">
                            ...
                            <svg class="mt-1 h-6 w-6 flex-shrink-0 text-green-500" fill="none" stroke="currentColor"
                        ...
                        <div class="flex items-start gap-4">
                            ...
                            <p class="leading-relaxed text-gray-700">
                                <span class="font-semibold text-gray-900">
                                    Wound Dressing / Stitches / Ulcer Care
                                </span>
                                – Post-surgery wounds, diabetic ulcers, minor burns
                            </p>
                        ...
                        <div class="flex items-start gap-4">
                            ...
                            <p class="leading-relaxed text-gray-700">
                                <span class="font-semibold text-gray-900">
                                    Injection / IV Push / Medication Admin
                                </span>
                                – Antibiotics, insulin, fluid therapy
                            </p>
                        ...
                        <div class="flex items-start gap-4">
                            ...
                            <p class="leading-relaxed text-gray-700">
                                <span class="font-semibold text-gray-900">
                                    Catheter Care / Suctioning
                                </span>
                                – Urinary catheter, respiratory suction
                            </p>
                        ...
                        <div class="flex items-start gap-4">
                            ...
                            <svg class="mt-1 h-6 w-6 flex-shrink-0 text-green-500" fill="none"
                            ...
                            <p class="leading-relaxed text-gray-700">
                                <span class="font-semibold text-gray-900">
                                    Medical Equipment Setup / Operation
                                </span>
                                – Oxygen cylinder, suction, nebulizer
                            </p>
                    ...
                    <div>
                        <div class="rounded-2xl border bg-[#F4F8FA] p-8">
                            
                            <p class="mb-10 text-base text-gray-600">
                                Each service below shows the nursing procedure followed by
                                the medical conditions or situations where it is commonly required.
                            </p>

                            <div class="grid grid-cols-1 lg:grid-cols-2 gap-6 text-sm">
                                <!-- Item -->
                                <div class="flex items-start gap-4">
                                    <svg class="mt-1 h-6 w-6 flex-shrink-0 text-green-500"
                                    ...
                                    <p class="leading-relaxed text-gray-700">
                                        <span class="font-semibold text-gray-900"> NG Tube Feeding / Care </span>
                                        – Swallowing difficulties, post-stroke
                                    </p>
                                </div>
                                ...
                                <div class="flex items-start gap-4">
                                    ...
                                    <p class="leading-relaxed text-gray-700">
                                        <span class="font-semibold text-gray-900"> Wound Dressing / Stitches / Ulcer
                                            Care </span>
                                        – Post-surgery wounds, diabetic ulcers, minor burns
                                    </p>
                                </div>
                                ...
                                <div class="flex items-start gap-4">
                                    ...
                                    <p class="leading-relaxed text-gray-700">
                                        <span class="font-semibold text-gray-900"> Injection / IV Push / Medication
                                            Admin </span>
                                        – Antibiotics, insulin, fluid therapy
                                    </p>
                                </div>
                                ...
                                <div class="flex items-start gap-4">
                                    ...
                                    <p class="leading-relaxed text-gray-700">
                                        <span class="font-semibold text-gray-900"> Nebulization Therapy </span>
                                        – Asthma, COPD, respiratory issues
                                    </p>
                                </div>
                                ...
                                <div class="flex items-start gap-4">
                                    ...
                                    <p class="leading-relaxed text-gray-700">
                                        <span class="font-semibold text-gray-900"> Catheter Care / Suctioning </span>
                                        – Urinary catheter, respiratory suction
                                    </p>
                                </div>
                                ...
                                <div class="flex items-start gap-4">
                                    ...
                                    <p class="leading-relaxed text-gray-700">
                                        <span class="font-semibold text-gray-900"> Vital Signs Monitoring </span>
                                        – BP, pulse, oxygen, blood sugar
                                    </p>
                                </div>
                                ...
                                <div class="flex items-start gap-4">
                                    ...
                                    <p class="leading-relaxed text-gray-700">
                                        <span class="font-semibold text-gray-900"> Medical Equipment Setup / Operation
                                        </span>
                                        – Oxygen cylinder, suction, nebulizer
                                    </p>
                                </div>
            ...
            <div class="mx-auto mt-8 max-w-4xl px-4 py-16">
                            ...
                            <template x-for="n in 5" :key="n">
                                <li class="flex items-center space-x-2">
                                    ...
                                    <span class="hidden sm:inline"
                                        x-text="['Location','Service', 'Address','Review','Payment'][n-1]"></span>
                                </li>
                            </template>
                        </ul>
                    </div>
                ...
                {{-- <div x-show="step === 2" y-transition>
                    <div class="rounded-xl border border-gray-200 bg-white p-8">
                        ...
                        <p class="mb-6 text-sm text-gray-500">
                            Choose your preferred nursing care services
                        </p>
                        ...
                        <div class="grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-3">
                            ...
                            <!-- Service Card -->
                            <label
                                class="group relative cursor-pointer rounded-xl border p-5 transition-all duration-200"
                                :class="formData.care.includes(1) 
                                    ? 'border-green-600 bg-green-50 shadow-sm' 
                                    : 'border-gray-200 hover:border-green-400 hover:shadow-sm'">
                
                                <input type="checkbox"
                                    value="1"
                                    x-model="formData.care"
                                    class="hidden">
                            ...
                            <label
                                class="group relative cursor-pointer rounded-xl border p-5 transition-all duration-200"
                                :class="formData.care.includes(2) 
                                    ? 'border-green-600 bg-green-50 shadow-sm' 
                                    : 'border-gray-200 hover:border-green-400 hover:shadow-sm'">
                            ...
                            <label
                                class="group relative cursor-pointer rounded-xl border p-5 transition-all duration-200"
                                :class="formData.care.includes(3) 
                                    ? 'border-green-600 bg-green-50 shadow-sm' 
                                    : 'border-gray-200 hover:border-green-400 hover:shadow-sm'">
                                ...
                                <div class="flex items-start justify-between">
                                    ...
                                    <div x-show="formData.care.includes(3)"
                                        class="flex h-6 w-6 items-center justify-center rounded-full bg-green-600 text-white text-sm">
                                        ✓
                                    </div>
                                </div>
                            </label>
                        ...
                        <div class="flex items-center justify-between">
                            ...
                            <button type="button"
                                @click="if (formData.care.length > 0) { step++ }"
                                :disabled="formData.care.length === 0"
                                class="inline-flex items-center rounded-md bg-green-600 px-4 py-2 text-sm text-white hover:bg-green-700 disabled:opacity-50">
                                Next
                            </button>
                        </div>
                ...
                {{-- <div x-show="step === 2" y-transition>
                    <div class="rounded-2xl border border-gray-200 bg-white p-8 shadow-sm">
                        ...
                        <div class="grid grid-cols-1 gap-5 sm:grid-cols-2 lg:grid-cols-3">
                            ...
                            @foreach ($nursingServices as $service)
                                <label
                                    class="group relative transform cursor-pointer rounded-2xl border bg-white p-7 transition-all duration-300 ease-out"
                                    :class="formData.nursingCare.includes('{{ $service->id }}') ?
                                        'border-green-600 shadow-xl  ring-green-200' :
                                        'border-gray-200 hover:border-green-400 hover:shadow-lg'">

                                    <!-- Hidden Checkbox -->
                                    <input type="checkbox" value="{{ $service->id }}" x-model="formData.nursingCare"
                                        class="hidden">

                                    <!-- Selected Badge -->
                                    <div class="absolute right-5 top-5 flex h-7 w-7 items-center justify-center rounded-full transition-all duration-300"
                                        :class="formData.nursingCare.includes('{{ $service->id }}') ?
                                            'bg-green-600 scale-100' :
                                            'bg-gray-200 scale-0 group-hover:scale-90'">

                                        <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4 text-white"
                                            viewBox="0 0 20 20" fill="currentColor">
                                            <path fill-rule="evenodd"
                                                d="M16.707 5.293a1 1 0 010 1.414l-7.25 7.25a1 1 0 01-1.414 0l-3.25-3.25a1 1 0 011.414-1.414L8.75 11.586l6.543-6.543a1 1 0 011.414 0z"
                                                clip-rule="evenodd" />
                                        </svg>
                                    </div>

                                    <!-- Service Name -->
                                    <h4 class="text-center text-base font-bold tracking-tight transition-colors duration-200"
                                        :class="formData.nursingCare.includes('{{ $service->id }}') ?
                                            'text-green-700' :
                                ...
                                <label
                                    class="group relative cursor-pointer rounded-xl border bg-white p-4 text-center transition-all duration-200"
                                    :class="formData.nursingCare.includes('{{ $service->id }}') ?
                                    ...
                                    <!-- Service Name -->
                                    <h4 class="text-lg font-semibold tracking-tighter transition-colors duration-200"
                                        :class="formData.nursingCare.includes('{{ $service->id }}') ?
                                            'text-green-700' :
                                            'text-gray-900 group-hover:text-green-600'">
                                        {{ $service->name }}
                                    ...
                                    <!-- Price -->
                                    <p class="mt-1 text-base font-semibold text-teal-600">
                                        ৳{{ number_format($service->price) }}
                                    </p>

                                </label>
                                <label
                                    class="group relative cursor-pointer rounded-xl border bg-white px-4 py-3 transition-all duration-200"
                                    :class="formData.nursingCare.includes('{{ $service->id }}') ?
                                        'border-green-600 bg-green-50' :
                                        'border-gray-200 hover:border-green-400 hover:shadow-sm'">
                                    ...
                                    <div class="flex items-center justify-between gap-3">
                                        ...
                                        <!-- Price -->
                                        <span class="whitespace-nowrap text-sm font-semibold text-teal-600">
                                            ৳{{ number_format($service->price) }}
                                        </span>
                        ...
                        <div class="flex items-center justify-between">
                            ...
                            <button type="button" @click="step--"
                                class="inline-flex items-center rounded-lg border border-gray-300 px-5 py-2.5 text-sm font-medium text-gray-700 transition hover:bg-gray-50">
                                Back
                            </button>

                            <button type="button" @click="if (formData.nursingCare.length > 0) step++"
                                :disabled="formData.nursingCare.length === 0"
                                class="inline-flex items-center rounded-lg bg-green-600 px-6 py-2.5 text-sm font-medium text-white shadow-sm transition hover:bg-green-700 disabled:cursor-not-allowed disabled:opacity-50">
                                Continue
                            </button>
                ...
                <div x-show="step === 2" y-transition>
                    <div class="rounded-2xl border border-gray-200 bg-white p-8 shadow-sm">
                        ...
                        <div class="flex flex-wrap gap-4">
                            ...
                            <template x-for="srv in nursingServices" :key="'srv-' + srv.id">

                                <label
                                    class="flex cursor-pointer items-center gap-3 rounded-full border px-5 py-2.5 text-sm font-medium transition-all duration-200"
                                    :class="formData.nursingCare.includes(srv.id) ?
                                        'border-green-400 bg-green-50 text-green-600' :
                                        'border-gray-200 bg-white text-gray-700 hover:border-green-300'">

                                    <!-- Hidden Checkbox -->
                                    <input type="checkbox" class="hidden" :value="srv.id"
                                        x-model.number="formData.nursingCare">

                                    <!-- Dot -->
                                    <span class="h-2.5 w-2.5 rounded-full transition-all duration-200"
                                        :class="formData.nursingCare.includes(srv.id) ?
                                            'bg-green-500' :
                                            'bg-gray-400'">
                                    </span>
                                    ...
                                    <!-- Price -->
                                    <span class="font-semibold" x-text="'৳ ' + srv.price">
                                    </span>
                        ...
                        <div class="flex items-center justify-between">
                            ...
                            <button type="button" @click="if (formData.nursingCare.length > 0) step++"
                                :disabled="formData.nursingCare.length === 0"
                                class="rounded-lg bg-green-600 px-6 py-2.5 text-sm font-medium text-white shadow-sm transition hover:bg-green-700 disabled:cursor-not-allowed disabled:opacity-50">
                                Continue
                            </button> --}}
                ...
                <div x-show="step === 3" y-transition x-data="{
                ...
                <div x-show="step === 4" y-transition>
                    <div class="rounded-xl border border-gray-200 bg-white p-8">
                        ...
                        <div class="space-y-4 rounded-xl border border-gray-200 p-5 text-sm">
                            ...
                            <div>
                                <span class="text-gray-600">Selected Services:</span>
                            </div>
                            <!-- Selected Services -->
