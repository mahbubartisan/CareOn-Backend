    ...
    <section class="mx-auto px-4 pb-16 pt-28">
        ...
        <div class="mb-6 flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
            ...
            <div class="flex items-center text-sm text-gray-600">
                ...
                {{-- <span class="mr-2 hidden sm:inline">Helpline:</span> --}}
                ...
                <form wire:submit.prevent="book" class="space-y-6">
                    ...
                    <div>
                        <label class="mb-1 block text-sm font-medium text-gray-900">
                            Your Problem <span class="text-red-500">*</span>
                        </label>
                        <textarea wire:model="form.problem" rows="4" placeholder="Briefly describe your symptoms..."
                    ...
                    <div>
                        ...
                        <div class="grid grid-cols-1 gap-4 lg:grid-cols-3">
                            ...
                            <div>
                                <label class="mb-1 block text-sm font-medium text-gray-900">
                                    Specilization <span class="text-red-500">*</span>
                                </label>
                                <select wire:model="form.doctor_type"
                            ...
                            <div x-data x-init="flatpickr($refs.appointmentDate, {
                                dateFormat: 'Y-m-d',
                                minDate: 'today',
                                defaultDate: @entangle("form.appointment_date").defer,
                                onChange: function(selectedDates, dateStr) {
                                    $wire.set('form.appointment_date', dateStr);
                                }
                            });">
                                <label class="mb-1 block text-sm font-medium text-gray-900">
                                    Appointment Date <span class="text-red-500">*</span>
                                ...
                                <input wire:ignore type="text" x-ref="appointmentDate"
                                    class="w-full rounded-xl border border-gray-200 px-4 py-3 text-sm focus:border-teal-500 focus:outline-none"
                            ...
                            <div x-data x-init="flatpickr($refs.appointmentTime, {
                                enableTime: true,
                                noCalendar: true,
                                dateFormat: 'h:i K', // 12-hour format with AM/PM
                                minuteIncrement: 15,
                                defaultDate: @entangle("form.appointment_time").defer,
                                onChange: function(selectedDates, dateStr) {
                                    $wire.set('form.appointment_time', dateStr);
                                }
                            });">
                                <label class="mb-1 block text-sm font-medium text-gray-900">
                                ...
                                <input wire:ignore type="text" x-ref="appointmentTime"
                                    class="w-full rounded-xl border border-gray-200 px-4 py-3 text-sm focus:border-teal-500 focus:outline-none"
                    ...
                    <div class="space-y-6">
                        ...
                        <div class="grid grid-cols-1 gap-4 lg:grid-cols-3">
                            ...
                            <div>
                                <label class="mb-1 block text-sm font-medium text-gray-900">Gender <span
                                        class="text-red-500">*</span>
                                </label>
                                <select wire:model="form.gender"
                                    class="w-full rounded-xl border border-gray-200 px-4 py-[13px] text-sm focus:border-teal-500 focus:outline-none">
