        ...
        <div x-show="showStepper" y-transition>
            <div class="mx-auto mt-8 max-w-4xl px-4 py-16">
                                            ...
                                            <div class="grid grid-cols-1 gap-3 lg:grid-cols-3">
                                                ...
                                                <template x-for="opt in level.care_options" :key="'opt-' + opt.id">
                                                    <label
                                                        ...
                                                        <span class="mt-1 text-sm font-semibold text-teal-600"
                                                            x-text="'৳ ' + opt.price"></span>
                                                    </label>
                                                </template>
                                            </div>
                ...
                <div x-show="step === 3" y-transition x-data="{
                    date: @entangle("bookingForm.date").live,
                    time: @entangle("bookingForm.time").live,
                    isValid() {
                        let baseValid =
                            this.date &&
                            this.time;
                    ...
                    <div class="rounded-xl border border-gray-200 bg-white p-8">
                        ...
                        <div class="grid grid-cols-1 lg:grid-cols-2 gap-4">
                            ...
                            <div>
                                ...
                                <input type="text" x-ref="datePicker" wire:model="bookingForm.date"
                            ...
                            <div>
                                ...
                                <input type="text" x-ref="timePicker" wire:model="bookingForm.time"
                                    placeholder="Select preferred time (AM / PM)"
                                    class="w-full rounded-xl border border-gray-300 px-4 py-2.5 text-sm focus:border-green-600 focus:outline-none" />
                            </div>
                ...
                <!-- Step 4: Address -->
                <div x-show="step === 4" y-transition x-data="{
                    ...
                    <div class="rounded-xl border border-gray-200 bg-white p-8">
                        ...
                        <div class="mt-2 space-y-5">
                            ...
                            <div class="grid grid-cols-1 gap-4 lg:grid-cols-3">
                                <div>
                                    <label class="mb-1 block text-sm font-medium text-gray-700">Age <span
                                            class="text-red-500">*</span></label>
