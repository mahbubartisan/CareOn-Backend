        ...
        <div class="grid grid-cols-1 gap-6 lg:grid-cols-3">
            ...
            <div class="space-y-4">
                ...
                <div class="flex items-start gap-3 rounded-xl border bg-white p-6">
                    ...
                    <div>
                        <h3 class="mb-2 font-semibold">Mobile | মোবাইল</h3>
                ...
                <div class="flex items-start gap-3 rounded-xl border bg-white p-6">
                    ...
                    <div>
                        <h3 class="mb-2 font-semibold">Email | ই-মেইল</h3>
                        <p class="text-sm text-gray-500">
            ...
            <div class="rounded-xl border bg-white p-6 lg:col-span-2">
                ...
                <form x-show="tab === 'general'" wire:key="general-form" y-transition class="space-y-4">
                    ...
                    <div>
                        <label class="mb-1 block text-sm font-medium">ই-মেইল | Email Address *</label>
                    ...
                    <div>
                        ...
                        <textarea wire:model="generalForm.message"
                            ...
                            rows="6" placeholder="Tell us how we can help you... | আমরা কীভাবে আপনাকে সাহায্য করতে পারি..."></textarea>
                ...
                <form x-show="tab === 'feedback'" wire:key="feedback-form" y-transition class="space-y-4">
                    ...
                    <div>
                        ...
                        <textarea wire:model="feedbackForm.message"
                            ...
                            rows="6" placeholder="Share your experience with us... | আপনার অভিজ্ঞতা শেয়ার করুন..."></textarea>
