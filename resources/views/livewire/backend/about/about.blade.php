            ...
            <table
                ...
                <tbody class="bg-white dark:bg-[#132337] divide-y divide-gray-200 dark:divide-[#233A57]">
                    @forelse ($abouts as $index => $about)
                        <tr>
                            <td class="px-6 py-4 whitespace-nowrap">{!! str()->limit($about->our_story, 50) !!}</td>
                            <td class="px-6 py-4 whitespace-nowrap">{!! str()->limit($about->our_mission, 50) !!}</td>
                            <td class="px-6 py-4 whitespace-nowrap">{!! str()->limit($about->our_vision, 50) !!}</td>
