<div>
    ...
    <script>
        document.addEventListener("DOMContentLoaded", function () {
            ...
            function initQuill(editorId, livewireField, initialValue) {
                ...
                quill.on('text-change', function () {
                    @this.set(livewireField, quill.root.innerHTML);
                });
        
                // Sync when Livewire updates
                Livewire.hook('message.processed', () => {
                    let updated = @this.get(livewireField);
                    if (quill.root.innerHTML !== updated) {
            ...
            initQuill('#editorOurStory', 'form.our_story', @json($form->our_story));
            initQuill('#editorOurMission', 'form.our_mission', @json($form->our_mission));
            initQuill('#editorOurVision', 'form.our_vision', @json($form->our_vision));
