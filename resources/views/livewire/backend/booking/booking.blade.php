                ...
                <tbody class="divide-y divide-gray-200 bg-white dark:divide-[#233A57] dark:bg-[#132337]">
                    @forelse ($bookings as $index => $booking)
                        <tr>
                            ...
                            <td class="whitespace-nowrap px-6 py-4">{{ $booking->service_name }}</td>
                            <td class="whitespace-nowrap px-6 py-4">{{ $booking->package_name ?: 'N/A' }}</td>
                            <td class="whitespace-nowrap px-6 py-4">{{ optional($booking->patient)->name ?: "N/A" }}
                            </td>
                            ...
                            <td class="whitespace-nowrap px-6 py-4">
                                <div class="flex items-center space-x-2">
                                    @can("booking detail")
                                        <a href="{{ route("booking.detail", $booking->id) }}" title="View">
                                            <!-- View Icon -->
                                            <svg class="h-5 w-5 text-gray-600 transition-colors duration-300 hover:text-blue-600 dark:text-gray-300 dark:hover:text-blue-600" xmlns="http://www.w3.org/2000/svg"
