...
<aside
    ...
    <nav class="flex flex-1 flex-col space-y-4 overflow-y-auto p-4">
        <ul class="space-y-2.5">
                ...
                <div x-data="{ open: {{ request()->routeIs("diagnostic.booking", "diagnostic.booking.detail", "ambulance.booking", "ambulance.booking.detail", "consultation.booking", "consultation.booking.detail", "visit.booking", "visit.booking.detail") ? "true" : "false" }} }">
                    ...
                    <div x-show="open" class="mt-2 space-y-2" role="menu" aria-label="Components"
                        ...
                        <ul class="ml-2">
                            ...
                            <!-- EmergencyNursing Service -->
                            @canany(["nursing booking", "nursing booking detail"])
                                <li
                                    class="{{ request()->routeIs("nursing.booking", "nursing.booking.detail") ? "text-blue-600 dark:text-blue-600" : "text-gray-400 dark:text-gray-100" }} group flex items-center rounded-md p-2 text-sm text-gray-400 hover:text-blue-500">
                                    <span
                                        class="{{ request()->routeIs("nursing.booking", "nursing.booking.detail") ? "text-blue-500" : "text-gray-400 group-hover:text-blue-500" }} mr-2 list-item list-inside list-disc text-sm">
                                    </span>
                                    <a href="{{ route("nursing.booking") }}" @click="open = true"
                                        class="{{ request()->routeIs("nursing.booking", "nursing.booking.detail") ? "text-blue-600" : "group-hover:text-blue-500" }} flex-grow">
                                        Emergency Nursing Bookings
                                    </a>
                                </li>
                            @endcanany
                        </ul>
            ...
            <!-- Care Providers -->
            @canany(["care provider", "care provider detail"])
                <div>
                    <a href="{{ route("provider") }}"
                        class="{{ request()->routeIs("provider", "provider.detail") ? "bg-blue-50 dark:bg-[#233A57] text-blue-600 dark:text-blue-600" : "text-gray-400 hover:text-blue-600 dark:text-gray-100" }} flex items-center space-x-3 rounded-md p-2 text-sm dark:hover:text-blue-600">
                        <span aria-hidden="true">
                        ...
                        <ul class="ml-2">
                            ...
                            @canany(["feedback", "view feedback"])
                                <li
                                    ...
                                    <a href="{{ route("feedback") }}" @click="open = true"
            ...
            <!-- Settings -->
            @canany(["view settings", "create settings", "edit settings", "delete settings", "view lab", "create lab",
                "edit lab", "delete lab"])
