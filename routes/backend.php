...
use App\Livewire\Backend\BookingManage\NursingServiceBooking;
use App\Livewire\Backend\BookingManage\NursingServiceBookingDetail;
...
use App\Livewire\Backend\CareProvider\CareProvider;
use App\Livewire\Backend\CareProvider\CareProviderDetail;
...
Route::middleware(['auth', 'verified'])->group(function () {
    ...
    Route::get('/nursing-service-bookings', NursingServiceBooking::class)->name('nursing.booking');
    Route::get('/nursing-service-booking/{bookingId}', NursingServiceBookingDetail::class)->name('nursing.booking.detail');
    ...
    Route::get('/care-providers', CareProvider::class)->name('provider');
    Route::get('/care-provider/{providerId}', CareProviderDetail::class)->name('provider.detail');
