...
class Physiotherapy extends Component
{
    ...
    public function storeOrder()
    {
        ...
        $booking = Booking::create([
            ...
            'total_price'       => $locationPrice + 1000, // 1000 is the static assessment price
    ...
    {
        return view('livewire.frontend.service.physiotherapy')->extends('livewire.frontend.layouts.app');
    }
}
