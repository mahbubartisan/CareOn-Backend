    ...
    public function store()
    {
        ...
        DB::transaction(function () {
            ...
            if ($this->form->formType === 'nursing-service') {
                ...
                // $this->validate([
                //     'nursing_services' => 'required|array|min:1',
                //     'nursing_services.*.name' => 'required|string|max:255',
                //     'nursing_services.*.price' => 'required|numeric|min:0',
                // ]);

                foreach ($this->form->nursing_services as $service) {
