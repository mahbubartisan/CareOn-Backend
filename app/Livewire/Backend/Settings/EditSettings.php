...
class EditSettings extends Component
{
    ...
    public function update()
    {
        $this->validate([
            ...
            'heroImage' => 'nullable|image|max:1024',
        ]);
        ...
        if ($this->heroImage) {
            $oldMedia = Media::where('id', $setting->heroImage)->first();
            ...
            $newHeroImage = $this->uploadMedia($this->heroImage, 'images/settings', 80);
            $newHeroImageId = $newHeroImage->id;
        } else {
            $newHeroImageId = $setting->hero_image;
        }
